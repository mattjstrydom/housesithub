> **Status (Aug 2026):** The live product at https://www.housesithub.com/ is now a **$47 Stripe course sales page** (not a waitlist). `index.html` is the source of truth for section order, CTAs, and offer copy. Parts of this doc still describe an earlier waitlist / Kajabi-style IA and font choices (Work Sans, paper bands) that have not fully shipped — treat those as aspirational brand direction unless updated.
